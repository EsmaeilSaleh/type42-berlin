...
static const Exam02Question g_exam02_level3_questions[] = {
	{"add_prime_sum",
	 ...
	 "}\n"
	 "\n"
	 "static int\tft_atoi_positive(char *s)\n"
	 "{\n"
	 "\tlong\tn;\n"
	 "\tint\t\ti;\n"
	 "\n"
...
static const Exam02Question g_exam02_level4_questions[] = {
	...
	{"ft_list_remove_if",
	 ...
	 "#include <stdlib.h>\n"
	 "\n"
	 "static void\tremove_head(t_list **head, void *data_ref, int (*cmp)())\n"
	 "{\n"
	 "\tt_list\t*tmp;\n"
	 "\n"
	 ...
	 "\tif (!begin_list || !cmp)\n"
	 "\t\treturn ;\n"
	 "\tremove_head(begin_list, data_ref, cmp);\n"
	 "\tcur = *begin_list;\n"
	 "\twhile (cur && cur->next)\n"
	 "\t{\n"
	 "\t\tif (cmp(cur->next->content, data_ref) == 0)\n"
	 "\t\t{\n"
	 "\t\t\ttmp = cur->next;\n"
